...
#				message(STATUS "_instantiate_variables(): Zeroing ${__VAR}")
				set(${__VAR})
			endif()
		endforeach()
	endif()
...
function(_remove_default_variables __IN_ARGS __OUT_ARGS)
	set(__TMP_LIST)
	foreach(__VAR IN LISTS ${__IN_ARGS}__LIST)
		...
		if(NOT "${${__IN_ARGS}__SRC_${__VAR}}" STREQUAL "default")
			message(STATUS "_remove_default_variables(): non-default source of ${__IN_ARGS}__SRC_${__VAR}: ${${__IN_ARGS}__SRC_${__VAR}}")
			list(APPEND __TMP_LIST "${__VAR}")
		endif()
	endforeach()
	set(${__IN_ARGS}__LIST ${__TMP_LIST})
	message(STATUS "_remove_default_variables(): ${__IN_ARGS}__LIST: ${${__IN_ARGS}__LIST}")
	_pass_arguments_higher(${__IN_ARGS} ${__OUT_ARGS})
endfunction()

function(_remove_variables_with_default_value __IN_ARGS __DEFAULT_ARGS __IN_ARGS__LIST __OUT_ARGS)
	set(__TMP_LIST)
	foreach(__VAR IN LISTS ${__IN_ARGS__LIST})
		if(NOT "${${__DEFAULT_ARGS}_${__VAR}}" STREQUAL "${${__IN_ARGS}_${__VAR}}")
			list(APPEND __TMP_LIST "${__VAR}")
			message("_remove_variables_with_default_value(): variable ${__VAR}  changed from \"${${__IN_ARGS}_${__VAR}}\" to \"${${__DEFAULT_ARGS}_${__VAR}}\".")
		endif()
	endforeach()
	set(${__IN_ARGS}__LIST ${__TMP_LIST})
	message(STATUS "_remove_variables_with_default_value(): __IN_ARGS__LIST: ${__IN_ARGS__LIST}: ${${__IN_ARGS__LIST}}")
	_pass_arguments_higher(${__IN_ARGS} ${__OUT_ARGS})
endfunction()
...
#		if("${__VAR}" STREQUAL "FLOAT_PRECISION")
#			message(STATUS "_clear_variables(): After clearing, FLOAT_PRECISION=${FLOAT_PRECISION}")
#		endif()
	endforeach()
endfunction()
...
#	message(STATUS "_blank_variables():")
	foreach(__VAR IN LISTS ${__IN_ARGS_LIST})
