...
#			endif()
			...
			_retrieve_instance_data(${__DEP_ID} CALL_APPLY_DEPEDENCY_ON_TARGET_WHEN_NO_DEPENDEE __CALL_APPLY_DEPEDENCY_ON_TARGET_WHEN_NO_DEPENDEE)
#			message(STATUS "finalizer(): Going to instantiate ${__DEP_ID}, __CALL_APPLY_DEPEDENCY_ON_TARGET_WHEN_NO_DEPENDEE: ${__CALL_APPLY_DEPEDENCY_ON_TARGET_WHEN_NO_DEPENDEE}")
			if(__CALL_APPLY_DEPEDENCY_ON_TARGET_WHEN_NO_DEPENDEE)
					_invoke_apply_dependency_to_target("" ${__DEP_ID} __FUNCTION_EXISTS)
			endif()
		endforeach()
