...
#		endif()
		...
		_calculate_hash(__BASE_ARGS "${__BASE_ARGS__LIST}" "" __BASE_HASH __HASH_SOURCE)
		foreach(__INSTANCE_ID IN LISTS __FEATURE_INSTANCES)
			...
			_retrieve_instance_data(${__INSTANCE_ID} I_FEATURES __I_ARGS __HASH_SOURCE)
			_calculate_hash(__I_ARGS "${__I_ARGS__LIST}" "" __I_HASH __HASH_SOURCE)
