...
#		nice_list_output(LIST ${__NICE_PARENTS} OUTVAR __NICE_PARENTS_LIST)
		...
		message(FATAL_ERROR "Template ${__TEMPLATE_NAME} is only required by means of function get_existing_target() (used for as dependency of ${__NICE_PARENTS_LIST}), and never actually defined. You have to use function build_target() for this template somewhere once to instantiate this template.")
	endif()
...
#			message(STATUS "_resolve_features(): __INSTANCE_ID: ${__INSTANCE_ID} __VARNAMES: ${__VARNAMES} __SERIALIZED_COMMON_ARGS__LIST: ${__SERIALIZED_COMMON_ARGS__LIST}. __OUT_RELATION: ${__OUT_RELATION}")
...
#			message(STATUS "_resolve_features(): Before promotion:\nx x x x x x x x x x x\n${__MSG}")
			if(__ERRORS)
				message(FATAL_ERROR ${__ERRORS})
			endif()			
		endforeach()
...
#		message(STATUS "_resolve_features(): - - - - - - - - - - - -")
#		message(STATUS "_resolve_features(): Starting promotions for __FEATURE_INSTANCES: ${__FEATURE_INSTANCES} __SERIALIZED_MODIFIERS: ${__SERIALIZED_MODIFIERS}")
...
#				message(STATUS "_resolve_features(): About to promote ${__INSTANCE_ID} ${__FEATUREBASE_ID} \"${__SERIALIZED_COMMON_ARGS__LIST}\"")
...
#			message(STATUS "_resolve_features(): removing __FEATUREBASE_ID: ${__FEATUREBASE_ID} from __GLOBAL_ALL_FEATUREBASES")
		...
		_retrieve_global_data(FEATUREBASES __ALL_FEATUREBASES)
#		message(STATUS "_resolve_features() New iteration with features to process: ${__ALL_FEATUREBASES}")
	endwhile()
endfunction()
