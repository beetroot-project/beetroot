	...
	if(__OUT)
		...
		if(${__FEATUREBASES_COUNT} GREATER 1)
			...
			if(${__TEMPLATE_COUNT} GREATER 1)
				...
				message(FATAL_ERROR "Cannot use get_existing_target() on templates ${__NICE_LIST}, because all those templates share an implementation and there is already more than one of it already requested, so the Beetroot does not know, which one to use.")
			else()
				message(FATAL_ERROR "Cannot use get_existing_target() on template ${__TEMPLATE_NAMES} because more than one instance of it is already requested, and the Beetroot does not know which one to use.")
			endif()
		endif()
	endif()
	set(${__OUT_INSTANCES} ${__OUT} PARENT_SCOPE)
