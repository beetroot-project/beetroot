...
#			message(STATUS "${__PADDING}_link_to_target(): ${__DEPENDEE_INSTANCE_ID} dep: ${__OUR_INSTANCE_ID} -> depdep ${__DEP_DEP_ID}")	
	...
	if(TARGET ${__DEPENDEE_TARGET_NAME})
   	...
   	_retrieve_instance_data(${__OUR_INSTANCE_ID} EXTERNAL_INFO __HAS_EXTERNAL_PROJECT)
   	if("${__HAS_EXTERNAL_PROJECT}" STREQUAL "")
   	   set(__HAS_EXTERNAL_PROJECT 0)
   	   set(__INSTALL_DIR "")
   	else()
	   	_parse_all_external_info(__HAS_EXTERNAL_PROJECT __PARSED)
   	   set(__HAS_EXTERNAL_PROJECT 1)
      	_retrieve_instance_data(${__OUR_INSTANCE_ID} PATH __TARGETS_CMAKE_PATH) 
      	get_filename_component(__TEMPLATE_DIR ${__TARGETS_CMAKE_PATH} DIRECTORY)
	      ...
	      _workout_install_dir_for_external(${__OUR_INSTANCE_ID} "${__PARSED_WHAT_COMPONENTS_NAME_DEPENDS_ON}" "${__EXTERNAL_BARE_NAME}"  "${__PARSED_INSTALL_PATH}" __INSTALL_DIR_STEM __INSTALL_DIR __BUILD_DIR __FEATUREFILETMP __FEATURES __MODIFIERS __EXTERNAL_ID __REUSED_EXISTING)
   	endif()
