...
#	message(STATUS "_descend_stack(): __NEW_STACK_TOP: ${__NEW_STACK_TOP}")
endfunction()
...
#	set_property(GLOBAL  PROPERTY __BURAK_STACK_${__STACK_TOP}_TARGET_NAME_HINT "")
	math(EXPR __NEW_STACK_TOP "${__STACK_TOP} - 1")
	set_property(GLOBAL PROPERTY __BURAK_STACK_TOP "${__NEW_STACK_TOP}")

#	get_property(__OLD_STACK GLOBAL  PROPERTY __BURAK_STACK_${__STACK_TOP})
#	message(STATUS "_ascend_stack(): Removing old stack top: __BURAK_STACK_${__STACK_TOP}: ${__OLD_STACK} __NEW_STACK_TOP: ${__NEW_STACK_TOP}")
endfunction()
...
function(_put_into_stack __KEYWORD __PAYLOAD_VAR __APPEND)
	...
	set_property(GLOBAL ${__APPEND}  PROPERTY _BURAK_STACK_${__STACK_TOP}_${__KEYWORD} ${${__PAYLOAD_VAR}})
#	message("set_property(GLOBAL ${__APPEND}  PROPERTY _BURAK_STACK_${__STACK_TOP}_${__KEYWORD} ${${__PAYLOAD_VAR}})")
	message(STATUS "_put_into_stack: put ${__PAYLOAD_VAR}: ${${__PAYLOAD_VAR}} into __BURAK_STACK_${__STACK_TOP}_${__KEYWORD}")
...
function(_get_value_from_stack __KEYWORD __OUT_VALUE)
	...
	message(STATUS "_get_value_from_stack(): got ${__OUT_VALUE}: ${${__OUT_VALUE}} from __BURAK_STACK_${__STACK_TOP}_${__KEYWORD}")
...
function(_get_dependencies_from_stack __OUT_DEPENDENCY_LIST)
   _get_value_from_stack(DEPENDENCY __IN_DEPENDENCY_LIST)
	message(STATUS "_get_dependencies_from_stack(): got __IN_DEPENDENCY_LIST: ${__IN_DEPENDENCY_LIST}")
	set(${__OUT_DEPENDENCY_LIST} "${__IN_DEPENDENCY_LIST}" PARENT_SCOPE)
endfunction()
function(_get_dependencies_from_stack __OUT_DEPENDENCY_LIST)
	get_property(__STACK_TOP GLOBAL PROPERTY __BURAK_STACK_TOP)
