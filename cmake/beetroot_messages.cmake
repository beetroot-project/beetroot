...
macro(_get_relative_path __PATH __OUT_PATH)
	if("${__PATH}" STREQUAL "")
		set(${__OUT_PATH})
	else()
#		message(STATUS "${__PADDING}_get_relative_path(): __PATH: \"${__PATH}\"")
		file(RELATIVE_PATH ${__OUT_PATH} "${SUPERBUILD_ROOT}" "${__PATH}")
	endif()
