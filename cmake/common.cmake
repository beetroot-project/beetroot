#include(verbose_makefile)
#include(configure_3rd_party_library)
include(missing_dependency)
#include(gather_arguments)

define_property(TARGET PROPERTY HASH BRIEF_DOCS "Hash of the arguments" FULL_DOCS "Hash of the arguments")
define_property(TARGET PROPERTY PARS BRIEF_DOCS "Target parameters" FULL_DOCS "Sorted list of all target's parameters")
define_property(TARGET PROPERTY ARGS BRIEF_DOCS "Target arguments" FULL_DOCS "List of all target's actual arguments in the same order as PARS property")
...
#macro (make_paths_absolute)
#	set(options )
#	set(oneValueArgs SOURCE_DIRECTORY OUTVAR)
#	set(multiValueArgs SOURCES)
#	cmake_parse_arguments(MPA "${options}" "${oneValueArgs}" "${multiValueArgs}" "${ARGN}")

#	set(${MPA_OUTVAR} "")
#	foreach(FILE ${MPA_SOURCES})
#		if (IS_ABSOLUTE ${FILE})
#			list(APPEND ${MPA_OUTVAR} ${FILE})
#		else()
#			list(APPEND ${MPA_OUTVAR} ${MPA_SOURCE_DIRECTORY}/${FILE})
#		endif()
#	endforeach()
#endmacro()
