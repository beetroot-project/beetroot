...
# If we needed to change the featurebase, set ${__OUT_MODIFED} in the parent scope.
function(_resolve_features_for_featurebase __FEATUREBASE_ID __OUT_MODIFIED)
...
#				message(STATUS "_resolve_features_for_featurebase(): About to promote ${__INSTANCE_ID} ${__FEATUREBASE_ID} \"${__SERIALIZED_COMMON_ARGS__LIST}\"")
	...
	endforeach()
	if(NOT __MODIFIED)
		set(__OUT_MODIFIED 1 PARENT_SCOPE)
	else()
		set(__OUT_MODIFIED 0 PARENT_SCOPE)
	endif()
endfunction()
...
#	message(STATUS "_resolve_features(): All featurebases to resolve: ${__ALL_FEATUREBASES}")
	while(NOT "${__ALL_FEATUREBASES}" STREQUAL "") 
		...
		_resolve_features_for_featurebase(${__FEATUREBASE_ID} __MODIFIED)
		if(NOT __MODIFIED)
#			message(STATUS "_resolve_features(): removing __FEATUREBASE_ID: ${__FEATUREBASE_ID} from __GLOBAL_ALL_FEATUREBASES")
			_remove_property_from_db(GLOBAL ALL FEATUREBASES ${__FEATUREBASE_ID} )
		else() #The feature list has been modified. We need to process it again to make sure that this modification agrees with other instances pointing to it
			_set_property_to_db(FEATUREBASEDB ${__FEATUREBASE_ID} F_FEATURES "${__SERIALIZED_COMMON_ARGS__LIST}" FORCE)
...
function(_get_promises_by_featurebase __FEATUREBASE_ID __OUT_INSTANCES)
	...
	message(STATUS "_get_promises_by_featurebase(): Attempting to find all promises for __FEATUREBASE_ID: ${__FEATUREBASE_ID}. templates associated with this featurebase __TEMPLATE_NAMES: ${__TEMPLATE_NAMES}")
	...
	if(__OUT) #If promises were found
		...
		message(STATUS "_get_promises_by_featurebase(): List of featurebases: __FEATUREBASES: ${__FEATUREBASES}")
