...
function(get_existing_target __TEMPLATE_NAME)
	...
	message(STATUS "Called get_existing_target(${__TEMPLATE_NAME}) on phase ${__GET_TARGET_BEHAVIOR}")
...
#	message(STATUS "get_target(): __TEMPLATE_NAME: ${__TEMPLATE_NAME} ARGN: ${ARGN}")
	...
	if(__VARIABLE_DIC_DWARF)
		message(STATUS "__VARIABLE_DIC_DWARF: ${__VARIABLE_DIC_DWARF}")
	endif()
