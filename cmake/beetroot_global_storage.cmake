...
function(_retrieve_featurebase_data __FEATUREBASE_ID __PROPERTY __OUT)
	...
	elseif("${__COLS_${__PROPERTY}}" STREQUAL "FILEDB")
		...
		if("${__PATH}" STREQUAL "")
			message(FATAL_ERROR "Internal Beetroot error: featurebase is missing F_PATH property")
		endif()
		_make_path_hash("${__PATH}" __KEY)
	elseif("${__COLS_${__PROPERTY}}" STREQUAL "TEMPLATEDB")
...
function(_retrieve_template_data __TEMPLATE_NAME_TO_FIX __PROPERTY __OUT)
	...
	if("${__COLS_${__PROPERTY}}" STREQUAL "INSTANCEDB")
		message(FATAL_ERROR "Internal error: Cannot retrieve instance column for property ${__PROPERTY} using template name")
	elseif("${__COLS_${__PROPERTY}}" STREQUAL "FEATUREBASEDB")
...
macro(_retrieve_file_pars __PATH_HASH __PROPERTY __OUT)
	_retrieve_file_data("${__PATH_HASH}" ${__PROPERTY} __TMP_SER_PARS__LIST)
...
macro(_retrieve_featurebase_pars __FEATUREBASE_ID __PROPERTY __OUT)
	_retrieve_featurebase_data(${__FEATUREBASE_ID} ${__PROPERTY} __TMP_SER_PARS__LIST)
	_unserialize_parameters(__TMP_SER_PARS ${__OUT})
endmacro()
...
function(_serialize_variables __ARGS __ARGS_LIST __OUT_SERIALIZED)
	set(OUT)
#	message(STATUS "_serialize_variables(): Serializing variables: ${${__ARGS_LIST}}...")
