...
#		message(STATUS "_instantiate_target(): __INSTANCE_NAME: ${__INSTANCE_NAME} __EXTERNAL_PROJECT_INFO: ${__EXTERNAL_PROJECT_INFO} __NOT_SUPERBUILD: ${__NOT_SUPERBUILD}")
		if(NOT (__EXTERNAL_PROJECT_INFO AND NOT __NOT_SUPERBUILD)) #We need to exclude dependency processing for external projects in the internal run.
			foreach(__DEP_INSTANCE_ID IN LISTS __DEP_IDS)
				...
				_retrieve_instance_data(${__DEP_INSTANCE_ID} EXTERNAL_INFO __DEP_EXTERNAL_PROJECT_INFO )
				if((NOT __DEP_EXTERNAL_PROJECT_INFO) OR (NOT __EXTERNAL_PROJECT_INFO)) #We will not link two external prjects to each other. They are already built. 
					if(TARGET ${__INSTANCE_NAME})
						_invoke_apply_to_target(${__DEP_INSTANCE_ID} ${__INSTANCE_ID} __FUNCTION_EXISTS)
#						message(STATUS "_instantiate_target(): __INSTANCE_NAME: ${__INSTANCE_NAME} __DEP_INSTANCE_NAME: ${__DEP_INSTANCE_NAME} __FUNCTION_EXISTS: ${__FUNCTION_EXISTS}")
	#					message(FATAL_ERROR "__FUNCTION_EXISTS: ${__FUNCTION_EXISTS} __DEP_INSTANCE_NAME: ${__DEP_INSTANCE_NAME}")
						if(TARGET "${__DEP_INSTANCE_NAME}" AND "${__FUNCTION_EXISTS}" STREQUAL "0")
							message(WARNING "_instantiate_target(): about to call target_link_libraries:\n __INSTANCE_ID: ${__INSTANCE_ID} Linking ${__INSTANCE_NAME} to ${__DEP_INSTANCE_NAME}. __FUNCTION_ABSENT: ${__FUNCTION_ABSENT} ")
...
#					message(STATUS "_instantiate_target(): __DEP_EXTERNAL_PROJECT_INFO: ${__DEP_EXTERNAL_PROJECT_INFO} __EXTERNAL_PROJECT_INFO: ${__EXTERNAL_PROJECT_INFO}")
				endif()
			endforeach()
		endif()
	endif()
