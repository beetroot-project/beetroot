...
#	message(STATUS "_store_file() __PATH_HASH: ${__PATH_HASH} __ALL_TEMPLATE_NAMES: ${__ALL_TEMPLATE_NAMES}")
	...
	_parse_file_options( "${__TARGETS_CMAKE_PATH}" ${__IS_TARGET_FIXED} ${__TEMPLATE_OPTIONS__REF} __SINGLETON_TARGETS __NO_TARGETS __LANGUAGES __NICE_NAME __EXPORTED_VARS __LINK_TO_DEPENDEE __CALL_APPLY_DEPEDENCY_ON_TARGET_WHEN_NO_DEPENDEE)
	if(__EXPORTED_VARS)
...
#		_add_property_to_db(FEATUREBASEDB ${__FEATUREBASE_ID} F_TEMPLATE_NAME       ${__TEMPLATE_NAME})
	...
	_set_property_to_db(FILEDB     ${__PATH_HASH} CALL_APPLY_DEPEDENCY_ON_TARGET_WHEN_NO_DEPENDEE ${__CALL_APPLY_DEPEDENCY_ON_TARGET_WHEN_NO_DEPENDEE})
