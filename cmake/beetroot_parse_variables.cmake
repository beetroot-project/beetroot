...
#			message(STATUS "${__PADDING}_get_variables(): ARGN: ${__ARG_LIST}")
		...
		_read_variables_from_args(__PARS __ARGS __ARGS "${__CALLING_FILE}" ${__ARG_LIST})
			if(NOT "${__DEBUG_VAR_NAME}" STREQUAL "")
...
function(_read_variables_from_args __PARS __ARGS __CALLING_FILE __OUT_ARGS)
	set(__OPTIONS)
	set(__oneValueArgs )
...
#	message(STATUS "${__PADDING}_read_variables_from_args(): __multiValueArgs:${__multiValueArgs} __oneValueArgs: ${__oneValueArgs}")
	set(__unparsed ${__PARSED_UNPARSED_ARGUMENTS})
	if(__unparsed)
		message(FATAL_ERROR "Undefined variables passed as arguments: ${__unparsed} in ${__CALLING_FILE} (all variables: ${ARGN})")
	endif()
