...
#	message(STATUS "${__PADDING}_store_featurebase(): __SERIALIZED_MODIFIERS: ${__SERIALIZED_MODIFIERS} __SERIALIZED_FEATURES: ${__SERIALIZED_FEATURES}")
...
#	message(STATUS "${__PADDING}_link_instances_together(): __DEPENDEE_ID: ${__DEPENDEE_ID} __DEPENDENT_ID: ${__DEPENDENT_ID}")
	...
	if(NOT "${__DEPENDEE_ID}" STREQUAL "")
		if(__IS_PROMISE)
			_add_property_to_db(INSTANCEDB ${__DEPENDEE_ID} I_PROMISED_CH "${__DEPENDENT_ID}")
		endif()
...
#	message(STATUS "${__PADDING}_move_parents_between_instances(): Adding parents of ${__OLD_INSTANCE_ID} to the new ${__NEW_INSTANCE_ID}. __PARENTS: ${__PARENTS}")
	foreach(__PARENT_ID IN LISTS __PARENTS)
		...
		_remove_property_from_db(FEATUREBASEDB ${__PARENT_FEATUREBASE} DEP_INSTANCES ${__OLD_INSTANCE_ID})
		_add_property_to_db(FEATUREBASEDB ${__PARENT_FEATUREBASE} DEP_INSTANCES ${__NEW_INSTANCE_ID})
		_retrieve_instance_data(${__PARENT_ID} I_PROMISED_CH __PARENT_PROMISED_CHILDREN)
		if("${__OLD_INSTANCE_ID}" IN_LIST __PARENT_PROMISED_CHILDREN)
			_remove_property_from_db(INSTANCEDB ${__PARENT_ID} I_PROMISED_CH ${__OLD_INSTANCE_ID})
			_add_property_to_db(INSTANCEDB ${__PARENT_ID} I_PROMISED_CH ${__NEW_INSTANCE_ID})
		endif()
		_add_property_to_db(INSTANCEDB ${__NEW_INSTANCE_ID} I_PARENTS ${__PARENT_ID})
