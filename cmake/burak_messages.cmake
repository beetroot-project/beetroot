function(_get_nice_name __INSTANCE_ID __OUT_NICE_NAME)
	...
	foreach(__SIB_ID IN LISTS __SIBLINGS)
		_retrieve_instance_data(${__SIB_ID} EXTERNAL_INFO EXTERNAL_INFO__LIST)
		if(EXTERNAL_INFO__LIST)
			_parse_external_info(EXTERNAL_INFO "${__TARGETS_CMAKE_PATH}" NAME __NICE_NAME)
			if(__NICE_NAME)
