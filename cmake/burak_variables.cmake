	...
	if(NOT "${__TMP}" STREQUAL 0)
		...
		foreach(__VAR_NR RANGE "${__PARS_LENGTH}")
			...
			if("${__VAR_NAME}" IN_LIST ${__OUT_ARGS}__LIST)
				message(FATAL_ERROR "Multiple definitions of the same variable/modifier (here: \"${__VAR_NAME}\") are not allowed. Modifiers and variables share the same namespace. Error encountered in ${__TARGETS_CMAKE_PATH}.")
			endif()
...
function(_single_feature_relation __FILE_HASH __VARNAME __PARS_PREFIX __ARG1_PREFIX __ARG2_PREFIX __OUT_RELATION)
	...
	elseif("${${__PARS_PREFIX}_${__VARNAME}__CONTAINER}" STREQUAL "VECTOR")
		...
		message(FATAL_ERROR "Internal beetroot error: unsupported container")
	endif()
endfunction()
