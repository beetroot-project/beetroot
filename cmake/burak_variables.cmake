...
function(_get_variables __TARGETS_CMAKE_PATH __ARGS_IN __OUT_VARIABLE_DIC __OUT_PARAMETERS_DIC __OUT_TEMPLATE_NAMES __OUT_EXTERNAL_PROJECT_INFO __OUT_IS_TARGET_FIXED __OUT_GLOBAL_OPTIONS)
	...
	set(__DEBUG_VAR_NAME COMPONENTS)
...
function(_parse_file_options __INSTANCE_ID __TARGETS_CMAKE_PATH __IS_TARGET_FIXED __TEMPLATE_OPTIONS __OUT_SINGLETON_TARGETS __OUT_NO_TARGETS __OUT_LANGUAGES)
...
function(_parse_external_target_options __INSTANCE_ID __TARGETS_CMAKE_PATH __EXTERNAL_OPTIONS __OUT_ASSUME_INSTALLED)
	...
	cmake_parse_arguments(__PARSED "${__OPTIONS}" "${__oneValueArgs}" "${__multiValueArgs}" ${__EXTERNAL_OPTIONS})
	set(__unparsed ${__PARSED_UNPARSED_ARGUMENTS})
	if(__unparsed)
		message(FATAL_ERROR "Undefined EXTERNAL_OPTIONS in ${__TARGETS_CMAKE_PATH}: ${__unparsed}")
	endif()
	
	set(${__OUT_ASSUME_INSTALLED} ${__PARSED_ASSUME_INSTALLED} PARENT_SCOPE)
endfunction()
