...
#   message(WARNING "_workout_install_dir_for_external for ${__INSTANCE_ID}")
...
function(_name_external_project_int __INSTANCE_ID __OUT_WHOLE_NAME __OUT_DEPENDENCIES)
   ...
   if(__DEPENDENCIES)
      ...
      foreach(__I_DEPENDENCY IN LISTS __DEPENDENCIES)
   	   ...
   	   set(__ALL_DEPENDENCIES ${__ALL_DEPENDENCIES} ${__I_DEPENDENCY})
         _name_external_project_int(${__I_DEPENDENCY} __DEP_NAME)
